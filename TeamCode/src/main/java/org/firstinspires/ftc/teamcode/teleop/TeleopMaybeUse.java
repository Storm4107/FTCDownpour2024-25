    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (Operator.getButton(GamepadKeys.Button.BACK)) {
                m_Superstructure.ManualInput(Operator.getLeftY(), Operator.getButton(GamepadKeys.Button.B), Operator.getButton(GamepadKeys.Button.A), Operator.getButton(GamepadKeys.Button.X));
                telemetry.addData(
