...
public class Auto3spec extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            m_Drive.AutoDriveRC(36, 0, 6.65, 8, runtime);
            m_Drive.SetHeading(180, 8.15, 9.5, runtime);

            m_Drive.AutoDriveRC(0, 12, 9.55, 10.4, runtime);
            m_Drive.AutoDriveRC(48, 0, 10.45, 12.4, runtime);
            m_Drive.AutoDriveRC(11, 0, 12.65, 13.2, runtime);
            m_Superstructure.pincher.closeWithScheduler(13.35, 13.9, runtime);
            m_Superstructure.setAutoPosition(1785, 14, 16.7, runtime);
