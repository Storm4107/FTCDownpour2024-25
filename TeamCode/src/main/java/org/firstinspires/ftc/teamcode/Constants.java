...
public class Constants {
    ...
    public static class AutoConstants {
        ...
        public static final PIDCoefficients TranslationPID = new PIDCoefficients(.0012, 0, 0);
        public static final PIDCoefficients StrafePID = new PIDCoefficients(.001, 0, 0.0);
        public static final PIDCoefficients HeadingPID = new PIDCoefficients(0.0, 0, 0.0);
